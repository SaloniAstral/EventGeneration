#!/usr/bin/env python3
"""
Stream Simulator for EC2 Driver
Simulates Times Square style ticker updates
"""
...
class StreamSimulator:
    ...
    async def _send_to_processor(self, tick: Dict):
        ...
        try:
            # In real implementation, this would send to EC2 #3
            ...
            # This could be via HTTP, WebSocket, or direct to Accumulo
